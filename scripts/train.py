...
Usage:
    uv run python scripts/train.py --arch cnn14 --epochs 30 --batch-size 32
    uv run python scripts/train.py detect --arch cnn14 --epochs 30 ...
    uv run python scripts/train.py classify --drone-path data/hf_dads_classify ...
"""
